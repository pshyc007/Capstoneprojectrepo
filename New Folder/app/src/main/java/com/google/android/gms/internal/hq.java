...
_L3:
    ...
    {
        for (Iterator iterator = list.iterator(); iterator.hasNext(); (new id(context, s, (String)iterator.next())).e()) { }
    }
    ...
    public static boolean a(Context context)
    {
        ...
        {
            ig.e("Could not find com.google.android.gms.ads.AdActivity, please make sure it is declared in AndroidManifest.xml.");
            return false;
        }
        boolean flag;
        if ((0x10 & resolveinfo.activityInfo.configChanges) == 0)
        {
            ig.e(String.format("com.google.android.gms.ads.AdActivity requires the android:configChanges value to contain \"%s\".", new Object[] {
                "keyboard"
            }));
            flag = false;
        } else
    ...
    public static void b(Context context)
    {
        ...
        } else
        {
            ...
            context.getApplicationContext().registerReceiver(new hu(null), intentfilter);
            d = true;
            return;
        }
    }
