...
public final class t
{
    ...
    public t(Context context, AttributeSet attributeset)
    {
        int i = 1;
        super();
        TypedArray typedarray = context.getResources().obtainAttributes(attributeset, c.AdsAttrs);
    ...
    private static AdSize[] a(String s)
    {
        String as[];
        AdSize aadsize[];
        int i;
