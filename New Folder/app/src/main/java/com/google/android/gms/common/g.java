...
public final class g
{
    ...
    public static int a(Context context)
    {
        ...
        if (mh.c(packageinfo.versionCode))
        {
    ...
    abyte0
        ...
        int i1 = mh.a(0x4da6e8);
        if (mh.a(packageinfo.versionCode) < i1)
        {
    ...
    public static Intent a(int i1)
    {
        ...
        case 1: // '\001'
        case 2: // '\002'
            return le.b("com.google.android.gms");

        case 3: // '\003'
            return le.a("com.google.android.gms");
    ...
    private static transient byte[][] a(byte abyte0[][][])
    {
        ...
        int i2 = 0;
        int k2;
        for (int j2 = 0; i2 < l1; j2 = k2)
        {
            byte abyte2[][] = abyte0[i2];
            k2 = j2;
            for (int l2 = 0; l2 < abyte2.length;)
            {
                int i3 = k2 + 1;
                abyte1[k2] = abyte2[l2];
                l2++;
    ...
    public static void b(Context context)
    {
        ...
        if (i1 != 0)
        {
            Intent intent = a(context, i1);
            Log.e("GooglePlayServicesUtil", (new StringBuilder()).append("GooglePlayServices not available due to error ").append(i1).toString());
            if (intent == null)
            {
                throw new e(i1);
            } else
            {
                throw new f(i1, "Google Play Services not available", intent);
            }
        } else
        {
            return;
...
_L1:
        ...
        if (bundle != null)
        {
            int i1 = bundle.getInt("com.google.android.gms.version");
