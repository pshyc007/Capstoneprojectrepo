...
public class ViewPager extends ViewGroup
{
    ...
    private static final bl af = new bl();
    ...
    private int a(int i1, float f1, int j1, int k1)
    {
        ...
        {
            be be1 = (be)e.get(0);
            be be2 = (be)e.get(-1 + e.size());
            i1 = Math.max(be1.b, Math.min(i1, be2.b));
        }
        return i1;
    }
    ...
    private void a(int i1, int j1, int k1, int l1)
    {
        if (j1 > 0 && !e.isEmpty())
        {
            ...
            if (!m.isFinished())
            {
                ...
                be be2 = b(i);
                m.startScroll(l2, 0, (int)(be2.e * (float)i1), 0, i3);
            }
        } else
        {
            be be1 = b(i);
    ...
    private void a(int i1, boolean flag, int j1, boolean flag1)
    {
        ...
        if (be1 != null)
        {
            k1 = (int)((float)getClientWidth() * Math.max(s, Math.min(be1.e, t)));
        } else
        {
            k1 = 0;
        }
    ...
    private void a(be be1, int i1, be be2)
    {
        int j1 = h.a();
        ...
        if (be2 != null)
        {
            ...
            if (i4 < be1.b)
            {
                float f9 = f1 + (be2.e + be2.d);
                int l4 = i4 + 1;
                for (int i5 = 0; l4 <= be1.b && i5 < e.size(); l4++)
                {
                    be be6;
                    for (be6 = (be)e.get(i5); l4 > be6.b && i5 < -1 + e.size(); be6 = (be)e.get(i5))
                    {
                        i5++;
                    }
            ...
            if (i4 > be1.b)
            {
                int j4 = -1 + e.size();
                float f8 = be2.e;
                for (int k4 = i4 - 1; k4 >= be1.b && j4 >= 0; k4--)
                {
                    be be5;
                    for (be5 = (be)e.get(j4); k4 < be5.b && j4 > 0; be5 = (be)e.get(j4))
                    {
                        j4--;
                    }
    ...
    {
        int i1 = android.support.v4.view.aa.b(motionevent);
        if (android.support.v4.view.aa.b(motionevent, i1) == J)
        {
            int j1;
            if (i1 == 0)
            {
            ...
            F = android.support.v4.view.aa.c(motionevent, j1);
            J = android.support.v4.view.aa.b(motionevent, j1);
            if (K != null)
            {
                K.clear();
            }
...
label0:
    ...
    private boolean d(int i1)
    {
        ...
        } else
        {
            ...
            int l1 = be1.b;
            float f2 = ((float)i1 / (float)j1 - be1.e) / (f1 + be1.d);
    ...
    private void f()
    {
        ...
        {
            if (!((bf)getChildAt(i1).getLayoutParams()).a)
            {
                removeViewAt(i1);
                i1--;
            }
...
label0:
    ...
    void a()
    {
        ...
        if (flag2)
        {
            ...
            for (j2 = 0; j2 < i2; j2++)
            {
                bf1 = (bf)getChildAt(j2).getLayoutParams();
                if (!bf1.a)
                {
                    bf1.c = 0.0F;
                }
...
_L23:
        ...
        be2 = (be)e.get(j2);
        if (be2.b < i) goto _L9; else goto _L8
_L8:
        if (be2.b != i)
        {
            break MISSING_BLOCK_LABEL_1294;
...
_L32:
        ...
        if (be3 == null) goto _L11; else goto _L10
_L10:
        int k3 = j2 - 1;
        af af1;
        int k2;
        ...
        {
            f1 = (2.0F - be3.d) + (float)getPaddingLeft() / (float)l3;
        }
        i4 = -1 + i;
        f2 = 0.0F;
        j4 = i4;
...
_L14:
        if (be7 != null) goto _L16; else goto _L13
_L13:
        f3 = be3.d;
        i5 = k4 + 1;
...
_L20:
        if (be9 != null) goto _L22; else goto _L18
_L18:
        a(be3, k4, be1);
          goto _L11
_L9:
...
_L27:
        ...
        if (be4 != null && be4.b == i) goto _L4; else goto _L28
_L28:
        j3 = 0;
_L31:
...
_L29:
        view1 = getChildAt(j3);
        be5 = a(view1);
        if (be5 != null && be5.b == i && view1.requestFocus(byte0)) goto _L4; else goto _L30
_L30:
        j3++;
          goto _L31
        be2 = null;
...
_L2:
        if (flag && al.a(view, -i1)) goto _L4; else goto _L6
_L6:
        return false;
...
_L7:
    ...
    public void addView(View view, int i1, android.view.ViewGroup.LayoutParams layoutparams)
    {
        ...
        bf1 = (bf)layoutparams1;
        bf1.a = bf1.a | (view instanceof bd);
        if (w)
        {
            if (bf1 != null && bf1.a)
            {
...
_L2:
        ...
        do
        {
            ...
            {
                be be1 = a(view);
                if (be1 != null && be1.b == i && view.dispatchPopulateAccessibilityEvent(accessibilityevent))
                {
                    return true;
                }
            }
...
_L3:
    ...
    protected int getChildDrawingOrder(int i1, int j1)
    {
        ...
        return ((bf)((View)ae.get(j1)).getLayoutParams()).f;
    }
...
_L3:
        ArrayList arraylist;
        for (; k2 > be1.b && j2 < k1; be1 = (be)arraylist.get(j2))
        {
            arraylist = e;
            j2++;
        }
...
_L7:
        ...
        int k1 = android.support.v4.view.aa.a(motionevent, j1);
        f3 = android.support.v4.view.aa.c(motionevent, k1);
        f4 = f3 - F;
        f5 = Math.abs(f4);
        f6 = android.support.v4.view.aa.d(motionevent, k1);
        f7 = Math.abs(f6 - I);
...
_L6:
        ...
        I = f2;
        G = f2;
        J = android.support.v4.view.aa.b(motionevent, 0);
        B = false;
...
_L3:
        ...
        if (!bf2.a) goto _L4; else goto _L5
_L5:
        int j6;
        int k6;
        j6 = 7 & bf2.b;
...
_L2:
        ...
        for (int l4 = 0; l4 < i2; l4++)
        {
            ...
            int i5 = l2 + (int)((float)k4 * be1.e);
            if (bf1.d)
            {
                bf1.d = false;
                view.measure(android.view.View.MeasureSpec.makeMeasureSpec((int)((float)k4 * bf1.c), 0x40000000), android.view.View.MeasureSpec.makeMeasureSpec(k2 - i3 - k3, 0x40000000));
            }
...
_L2:
        ...
        for (i3 = 0; i3 < l2; i3++)
        {
            ...
            bf1 = (bf)view.getLayoutParams();
            if (bf1 == null || !bf1.a)
            {
                view.measure(android.view.View.MeasureSpec.makeMeasureSpec((int)((float)l1 * bf1.c), 0x40000000), v);
            }
        }
    ...
    protected boolean onRequestFocusInDescendants(int i1, Rect rect)
    {
        ...
        for (; k1 != j1; k1 += byte0)
        {
            ...
            be be1 = a(view);
            if (be1 != null && be1.b == i && view.requestFocus(i1, rect))
            {
                return true;
            }
        }
...
_L4:
        if (!A)
        {
            int j2 = android.support.v4.view.aa.a(motionevent, J);
            float f1 = android.support.v4.view.aa.c(motionevent, j2);
            float f2 = Math.abs(f1 - F);
            float f3 = android.support.v4.view.aa.d(motionevent, j2);
        ...
        if (flag3)
        {
            flag = false | b(android.support.v4.view.aa.c(motionevent, android.support.v4.view.aa.a(motionevent, J)));
        }
        continue; /* Loop/switch isn't completed */
_L3:
        boolean flag2 = A;
        ...
        if (flag2)
        {
            ...
            int k1 = (int)android.support.v4.view.ag.a(velocitytracker, J);
            y = true;
            int l1 = getClientWidth();
            int i2 = getScrollX();
            be be1 = h();
            a(a(be1.b, ((float)i2 / (float)l1 - be1.e) / be1.d, k1, (int)(android.support.v4.view.aa.c(motionevent, android.support.v4.view.aa.a(motionevent, J)) - H)), true, true, k1);
            J = -1;
            i();
            flag = Q.c() | R.c();
        }
...
_L5:
        ...
        continue; /* Loop/switch isn't completed */
_L6:
        int j1 = android.support.v4.view.aa.b(motionevent);
        F = android.support.v4.view.aa.c(motionevent, j1);
        J = android.support.v4.view.aa.b(motionevent, j1);
        flag = false;
        continue; /* Loop/switch isn't completed */
_L7:
        a(motionevent);
        F = android.support.v4.view.aa.c(motionevent, android.support.v4.view.aa.a(motionevent, J));
        flag = false;
...
_L8:
    ...
    void setOnAdapterChangeListener(bg bg1)
    {
        aa = bg1;
    }

    public void setOnPageChangeListener(bh bh1)
    {
        W = bh1;
    }
    ...
    private class SavedState extends android.view.View.BaseSavedState
    {
        ...
        public static final android.os.Parcelable.Creator CREATOR = android.support.v4.c.a.a(new bk());
        int a;
        Parcelable b;
        ClassLoader c;
