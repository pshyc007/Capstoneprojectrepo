...
_L6:
    ...
    {
        int i1 = aa.c(motionevent);
        for (int j1 = 0; j1 < i1; j1++)
        {
            int k1 = aa.b(motionevent, j1);
            float f1 = aa.c(motionevent, j1);
            float f2 = aa.d(motionevent, j1);
            f[k1] = f1;
            g[k1] = f2;
        }
    ...
    private void h()
    {
        ...
        a(a(ag.a(l, c), n, m), a(ag.b(l, c), n, m));
    }
    ...
    public boolean a(int i1, int j1)
    {
        ...
        {
            return a(i1, j1, (int)ag.a(l, c), (int)ag.b(l, c));
        }
    }
...
_L2:
        ...
        if ((i3 & p) != 0)
        {
          ...
          goto _L7
_L5:
        int j2 = aa.b(motionevent, j1);
        float f5 = aa.c(motionevent, j1);
        float f6 = aa.d(motionevent, j1);
        a(f5, f6, j2);
        if (a == 0)
        {
            int k2 = h[j2];
...
_L8:
        i2 = aa.b(motionevent, l1);
        f1 = aa.c(motionevent, l1);
        f2 = aa.d(motionevent, l1);
        f3 = f1 - d[i2];
        f4 = f2 - e[i2];
        b(f3, f4, i2);
...
_L6:
        ...
        float f10;
        int j4;
        i4 = aa.b(motionevent, k1);
        f9 = aa.c(motionevent, k1);
        f10 = aa.d(motionevent, k1);
        a(f9, f10, i4);
        if (a != 0)
        {
...
_L4:
        ...
        if (a == 1)
        {
            int j3 = aa.a(motionevent, c);
            float f7 = aa.c(motionevent, j3);
            float f8 = aa.d(motionevent, j3);
            int k3 = (int)(f7 - f[c]);
            int l3 = (int)(f8 - g[c]);
...
_L10:
        ...
        float f5;
        float f6;
        i3 = aa.b(motionevent, i1);
        f3 = aa.c(motionevent, i1);
        f4 = aa.d(motionevent, i1);
        f5 = f3 - d[i3];
        f6 = f4 - e[i3];
        b(f5, f6, i3);
...
_L13:
        i1++;
          goto _L14
_L7:
        int l1 = aa.b(motionevent, k1);
        if (a != 1 || l1 != c) goto _L16; else goto _L15
_L15:
        int i2 = aa.c(motionevent);
_L21:
        if (i1 >= i2) goto _L18; else goto _L17
_L17:
        int k2 = aa.b(motionevent, i1);
...
_L20:
        float f1;
        float f2;
        f1 = aa.c(motionevent, i1);
        f2 = aa.d(motionevent, i1);
