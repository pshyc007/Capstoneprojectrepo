...
_L3:
    ...
    y a(String s, boolean flag, boolean flag1)
    {
        if (l == null)
        {
            l = new l();
    ...
    public View onCreateView(String s, Context context, AttributeSet attributeset)
    {
        ...
        if (fragment == null)
        {
            ...
            fragment1.p = true;
            fragment1.s = b;
            fragment1.a(this, attributeset, fragment1.d);
            b.a(fragment1, true);
            fragment = fragment1;
        } else
        {
            ...
            if (!fragment.C)
            {
                fragment.a(this, attributeset, fragment.d);
            }
            b.b(fragment);
        }
        if (fragment.I == null)
