    ...
    implements Runnable
{
    ...
    public v a(int i1, Fragment fragment, String s1)
    {
        a(i1, fragment, s1, 1);
        return this;
    }
        ...
        if (k)
        {
            ...
            while (c1 != null) 
            {
                if (c1.d != null)
                {
                    ...
                    if (n.a)
                    {
                        Log.v("FragmentManager", (new StringBuilder()).append("Bump nesting of ").append(c1.d).append(" to ").append(c1.d.r).toString());
                    }
                }
                if (c1.i != null)
                {
...
_L2:
        ...
        fragment7.G = c1.h;
        a.a(fragment7, android.support.v4.app.n.c(i), j);
_L11:
        c1 = c1.b;
...
_L9:
        ...
        {
            fragment5.G = c1.h;
            a.a(fragment5, android.support.v4.app.n.c(i), j);
        }
        if (c1.i != null)
        {
            int i1 = 0;
...
_L5:
        ...
        fragment3.G = c1.g;
        a.c(fragment3, android.support.v4.app.n.c(i), j);
          goto _L11
_L6:
        Fragment fragment2 = c1.d;
        fragment2.G = c1.h;
        a.b(fragment2, android.support.v4.app.n.c(i), j);
          goto _L11
_L7:
        Fragment fragment1 = c1.d;
        fragment1.G = c1.g;
        a.e(fragment1, android.support.v4.app.n.c(i), j);
          goto _L11
        Fragment fragment = c1.d;
        fragment.G = c1.g;
        a.d(fragment, android.support.v4.app.n.c(i), j);
          goto _L11
        if (flag)
        {
            a.a(a.n, android.support.v4.app.n.c(i), j, true);
        }
        if (o >= 0)
        {
            a.b(o);
